...
from core.schemas.pydantic_validators import (
    lowercase_email_username,
    username_validator,
    names_validator,
    contact_validator,
    general_validator,
...
class UserCreateSchema(BaseModel):
    ...
    lowercase_email = validator("email", allow_reuse=True)(
        lowercase_email_username
    )
...
class UserReadSchema(BaseModel):
    ...
    first_name: str | None = Field(
        None, min_length=1, max_length=3_0, example="John"
    )
    first_name_validator = validator("first_name", allow_reuse=True)(
        names_validator
    )
    last_name: str | None = Field(
        None, min_length=1, max_length=3_0, example="Doe"
    )
    last_name_validator = validator("last_name", allow_reuse=True)(
        names_validator
    )
    contact: str | None = Field(
        None, min_length=1, max_length=3_0, example="(02) 123-4567"
    )
    contact_validator = validator("contact", allow_reuse=True)(
        contact_validator
    )
    username: str = Field(
        None, min_length=1, max_length=3_0, example="johndoe"
    )
    ...
    company_name: str | None = Field(
        None, min_length=1, max_length=3_0, example="Company Name"
    )
    company_name_validator = validator("company_name", allow_reuse=True)(
        general_validator
    )
    address: str | None = Field(
        None, min_length=1, max_length=1_00, example="Address"
    )
    address_validator = validator("address", allow_reuse=True)(
        general_validator
    )
    city: str | None = Field(
        None, min_length=1, max_length=3_0, example="City"
    )
    city_validator = validator("city", allow_reuse=True)(general_validator)
    country: str | None = Field(
        None, min_length=1, max_length=3_0, example="Country"
    )
    country_validator = validator("country", allow_reuse=True)(
        general_validator
    )
    postal_code: str | None = Field(
        None, min_length=1, max_length=6, example="12345"
    )
    postal_code_validator = validator("postal_code", allow_reuse=True)(
        general_validator
    )
...
class UserUpdateSchema(BaseModel):
    ...
    postal_code: str | None = Field(
        None, min_length=1, max_length=3_0, example="12345"
    )
    postal_code_validator = validator("postal_code", allow_reuse=True)(
        general_validator
    )
